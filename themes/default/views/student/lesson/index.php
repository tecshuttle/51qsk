								...
								<table class="table">
									...
									<?php foreach ($lessons as $lesson): ?>
										<tr>
											...
											<td width="150"><?= $lesson['is_arrival'] == 0 ? '<span class="center-block history">未签到</span>' : '<span class="center-block history">已签到</span>
											<a class="btn btn-red btn-sm btn-sm-padding" href=" ' .Yii::app()->createUrl('student/lesson/review',array('id' => $lesson['lesson_id'])).'">去评价</a>' ?></td>
