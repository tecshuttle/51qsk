...
<div class="admin-table admin-tab admin-size-sm admin-table-list admin-class-list">
								<table class="table">
									<caption>
										...
										<a class="active" href="<?= Yii::app()->createUrl('student/lesson/expiredLesson') ?>">过期课程</a>
									</caption>
									<thead>
										<tr>
											<th>&nbsp;</th>
									...
									<tbody>
										<?php foreach ($expiredLessons as $expiredLesson): ?>
										<tr>
											<td width="150">
												<a href="<?= $this->createUrl('/lesson/view', array('id' => $expiredLesson['lesson_id'])) ?>">
													<img class="img-responsive" src="<?= $expiredLesson['pic'] ?>">
												</a>
											</td>
											<td width="200">
												<a href="<?= $this->createUrl('/lesson/view', array('id' => $expiredLesson['lesson_id'])) ?>">
											...
											<td width="220">
												<s><?= substr($expiredLesson['start_date_time'], 0, 10) ?></s><br/>
												<s><?= substr($expiredLesson['end_date_time'], 0, 10) ?></s>
											</td>
                                            <td width="150">
									...
									<nav class="text-center cp-pagination">
										<?php if ($pager->pageCount > 1 || true) { ?>
											<ul class="pagination pagination-sm">
												<li>
													<a href="<?php echo Yii::app()->createUrl('student/lesson/expiredLesson', array_merge($_GET, array('page' => 1))) ?>">页首</a>
												</li>
												<li>
													...
													<?php } else { ?>
														<a disabled href="<?php echo Yii::app()->createUrl('student/lesson/expiredLesson', array_merge($_GET, array('page' => $pager->currentPage))) ?>" aria-label="Previous">
															<span aria-hidden="true">上一页</span>
														</a>
													<?php } ?>
												...
												<li <?= $i == $page ? 'class="active"' : '' ?>><a
														href='<?php echo Yii::app()->createUrl('student/lesson/expiredLesson', array_merge($_GET, array('page' => $i))) ?>'><?php echo $i ?></a>
												</li>
												<?php } ?>
												<li>
													...
													<?php } else { ?>
														<a href="<?php echo Yii::app()->createUrl('student/lesson/expiredLesson', array_merge($_GET, array('page' => $pager->currentPage + 2))) ?>" aria-label="Next">
															<span aria-hidden="true">下一页</span>
														</a>
													<?php } ?>
												</li>
												<li>
													<a href="<?php echo Yii::app()->createUrl('student/lesson/expiredLesson', array_merge($_GET, array('page' => $pager->pageCount))) ?>">页尾</a>
												</li>
