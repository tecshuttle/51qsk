...
class LessonRecommendController extends XAdminiBase
{
    /**
     * 首页
     *
    ...
    public function actionIndex() {
		...
		$criteria->addCondition('recommendation = :recommendation');
        ...
        $this->render( 'lessonRecommend_index', array ( 'datalist' => $result , 'pagebar' => $pages ) );
    }
    ...
    public function actionUpdate( $id ) {
        ...
        $this->render( 'lesson_update', array ( 'model' => $model) );
    ...
    public function actionBatch() {
        ...
        empty( $ids ) && XUtils::message( 'error', '未选择记录' );
         ...
         switch ( $command ) {
        case 'delete':
            parent::_acl( 'lessonRecommend_delete' );
            AdminLogger::_create( array ( 'catalog' => 'delete' , 'intro' => '删除内容，ID:' . $ids ) ); 
            parent::_delete( new Lesson(), $ids, array ( 'index' ));
            break;
        default:
