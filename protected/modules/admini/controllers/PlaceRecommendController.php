...
class PlaceRecommendController extends XAdminiBase
{
    /**
     * 首页
     *
    ...
    public function actionIndex() {
        ...
        $this->render( 'placeRecommend_index', array ( 'datalist' => $result , 'pagebar' => $pages ) );
    }
    ...
    public function actionUpdate( $id ) {
        ...
        $this->render( 'placeRecommend_update', array ( 'model' => $model) );
    ...
    public function actionBatch() {
        ...
        empty( $ids ) && XUtils::message( 'error', '未选择记录' );
         ...
         switch ( $command ) {
        case 'delete':
            parent::_acl( 'placeRecommend_delete' );
