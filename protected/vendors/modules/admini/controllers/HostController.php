...
class HostController extends XAdminiBase
{
    /**
     * 首页
     *
    ...
    public function actionIndex() {
        ...
        $this->render( 'host_index', array ( 'datalist' => $result , 'pagebar' => $pages ) );
    }
    ...
    public function actionBatch() {
        ...
        empty( $ids ) && XUtils::message( 'error', '未选择记录' );
         ...
         switch ( $command ) {
        case 'delete':
            parent::_acl( 'host_delete' );
            AdminLogger::_create( array ( 'catalog' => 'delete' , 'intro' => '删除内容，ID:' . $ids ) ); 
            parent::_delete( new Host(), $ids, array ( 'index' ));
            break;
        default:
