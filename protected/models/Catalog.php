...
class Catalog extends XBaseModel
{
    ...
    public function relations()
    {
        ...
        return array(
			'lessons' => array(self::HAS_MANY, 'Lesson', 'catalog_id'),
			'hosts' => array(self::HAS_MANY, 'Host', 'catalog_id'),
		);
    }
    ...
    {
        return Catalog::model()->findAllByAttributes(array('parent_id' => 6, 'menu_is' => 'Y'));
    }
