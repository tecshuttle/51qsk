...
/**
 * This is the model class for table "{{place_review}}".
 *
 * The followings are the available columns in table '{{place_review}}':
 * @property string $id
...
class PlaceReview extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('place_id, teacher_id, traffic, equipment, feel, service', 'length', 'max'=>10),
			array('comment', 'length', 'max'=>500),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, place_id, teacher_id, traffic, equipment, feel, service, comment', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('feel',$this->feel,true);
