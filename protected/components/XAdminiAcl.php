...
class XAdminiAcl
{
	...
	public static $aclList = array(
		...
		'推荐' => array(
           'url'=>'lessonRecommend/index', 'acl'=>'recommendation','action'=>array(
                array('name'=>'课程推荐','url'=>'lessonRecommend/index','acl'=>'lessonRecommend_index','list_acl'=>array(
                        '录入'=>'lessonRecommend_create', '编辑'=>'lessonRecommend_update', '删除'=>'lessonRecommend_delete'
                        )),
				array('name'=>'场地推荐','url'=>'placeRecommend/index','acl'=>'placeRecommend_index','list_acl'=>array(
                        '录入'=>'placeRecommend_create', '编辑'=>'placeRecommend_update', '删除'=>'placeRecommend_delete'
                        )),
            )
          ),
		
		'审核管理' => array(
           'url'=>'student/index', 'acl'=>'management','action'=>array(
                array('name'=>'学员管理','url'=>'student/index','acl'=>'student_index','list_acl'=>array(
                        '录入'=>'student_create', '编辑'=>'student_update', '批量变更状态'=>'student_verify', '删除'=>'student_delete'
                        )),
				array('name'=>'场地管理','url'=>'place/index','acl'=>'place_index','list_acl'=>array(
                        '录入'=>'place_create', '编辑'=>'place_update', '批量变更状态'=>'place_verify', '删除'=>'place_delete'
                        )),
				array('name'=>'导师管理','url'=>'teacher/index','acl'=>'teacher_index','list_acl'=>array(
                        '录入'=>'teacher_create', '编辑'=>'teacher_update', '批量变更状态'=>'teacher_verify', '删除'=>'teacher_delete'
                        )),
				array('name'=>'场地主管理','url'=>'host/index','acl'=>'host_index','list_acl'=>array(
                          '录入'=>'host_create', '编辑'=>'host_update', '批量变更状态'=>'host_verify', '删除'=>'host_delete'
                        )),
				array('name'=>'著作管理','url'=>'book/index','acl'=>'book_index','list_acl'=>array(
                          '录入'=>'book_create', '编辑'=>'book_update', '批量变更状态'=>'book_verify', '删除'=>'book_delete'
                        )),
				array('name'=>'评论管理','url'=>'review/index','acl'=>'review_index','list_acl'=>array(
                          '录入'=>'review_create', '编辑'=>'review_update', '批量变更状态'=>'review_verify', '删除'=>'review_delete'	
                        )),
				array('name'=>'课程管理','url'=>'lesson/index','acl'=>'lesson_index','list_acl'=>array(
                          '录入'=>'lesson_create', '编辑'=>'lesson_update', '批量变更状态'=>'lesson_verify', '删除'=>'lesson_delete'
                        )),
				array('name'=>'亲子活动','url'=>'family/index','acl'=>'family_index','list_acl'=>array(
                          '录入'=>'family_create', '编辑'=>'family_update','删除'=>'family_delete'
                        )),
            )
          ),
